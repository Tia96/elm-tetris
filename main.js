		...
		$elm$core$Array$fromList(
			A2(
				...
				A2(
					...
					A2($elm$core$List$repeat, 10, $author$project$Main$Empty)),
				_List_fromArray(
					[$author$project$Main$Wall])))),
	A2(
		$elm$core$Array$repeat,
		1,
		A2($elm$core$Array$repeat, 12, $author$project$Main$Wall)));
...
var $author$project$Main$generateMinoPos = function (type_) {
	switch (type_.$) {
		case 'T':
			return _List_fromArray(
				[
...
var $author$project$Main$newMino = function (type_) {
	return {
		minoPos: $author$project$Main$generateMinoPos(type_),
		topPos: {x: 5, y: 1},
		type_: type_
	};
};
var $author$project$Main$NewMino = function (a) {
	return {$: 'NewMino', a: a};
};
...
var $author$project$Main$rand = A2(
	$elm$random$Random$uniform,
	$author$project$Main$T,
	_List_fromArray(
		[$author$project$Main$I, $author$project$Main$O, $author$project$Main$L, $author$project$Main$J, $author$project$Main$S, $author$project$Main$Z]));
var $author$project$Main$setInitialModel = $elm$core$Platform$Cmd$batch(
	_List_fromArray(
		[
			A2($elm$core$Task$perform, $author$project$Main$SetSystemTime, $elm$time$Time$now),
			A2($elm$random$Random$generate, $author$project$Main$NewMino, $author$project$Main$rand)
		]));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			board: $author$project$Main$initBoard,
			headMino: $author$project$Main$newMino($author$project$Main$T),
			score: 0,
			startTime: $elm$time$Time$millisToPosix(0),
			updateMills: 500
		},
		$author$project$Main$setInitialModel);
};
...
var $author$project$Main$UpdateLeft = {$: 'UpdateLeft'};
var $author$project$Main$UpdateRRotate = {$: 'UpdateRRotate'};
var $author$project$Main$UpdateRight = {$: 'UpdateRight'};
var $author$project$Main$toKey = function (keyValue) {
	switch (keyValue) {
		case 'ArrowLeft':
			return $author$project$Main$UpdateLeft;
		case 'ArrowRight':
			return $author$project$Main$UpdateRight;
		case 'ArrowUp':
			return $author$project$Main$UpdateRRotate;
		default:
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				function (time) {
					return $author$project$Main$Update(time);
				})
			]));
};
var $author$project$Main$LRotate = {$: 'LRotate'};
var $author$project$Main$Left = {$: 'Left'};
var $author$project$Main$RRotate = {$: 'RRotate'};
...
var $author$project$Main$addPos = F2(
	function (pos1, pos2) {
		return {x: pos1.x + pos2.x, y: pos1.y + pos2.y};
	});
var $author$project$Main$getEachPos = function (mino) {
	return A2(
		$elm$core$List$map,
		$author$project$Main$addPos(mino.topPos),
		mino.minoPos);
};
var $author$project$Main$Block = {$: 'Block'};
...
var $author$project$Main$getState = F2(
	function (pos, model) {
		return A2(
			...
			A2(
				...
				A2(
					...
					A2($elm$core$Array$get, pos.y, model.board))));
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$isCollide = F2(
	function (model, mino) {
		return 0 < $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				$elm$core$Basics$neq($author$project$Main$Empty),
				A2(
					$elm$core$List$map,
					function (pos) {
						return A2($author$project$Main$getState, pos, model);
					},
					$author$project$Main$getEachPos(mino))));
	});
var $author$project$Main$rotatePos = F2(
	function (move, poses) {
		switch (move.$) {
			case 'RRotate':
				return A2(
...
var $author$project$Main$moveMino = F2(
	function (move, mino) {
		switch (move.$) {
			case 'Down':
			...
			case 'RRotate':
				return _Utils_update(
					mino,
					{
						minoPos: A2($author$project$Main$rotatePos, $author$project$Main$RRotate, mino.minoPos)
					});
			default:
				return _Utils_update(
					mino,
					{
						minoPos: A2($author$project$Main$rotatePos, $author$project$Main$LRotate, mino.minoPos)
					});
		}
	});
var $author$project$Main$moveModel = F2(
	function (move, model) {
		var nextMino = A2($author$project$Main$moveMino, move, model.headMino);
		return A2($author$project$Main$isCollide, model, nextMino) ? model : _Utils_update(
			model,
			{headMino: nextMino});
	});
...
var $author$project$Main$calcScore = function (board) {
	return $elm$core$Array$length(
		A2(
			$elm$core$Array$filter,
			$elm$core$Basics$eq(10),
			A2(
				$elm$core$Array$map,
				function (array) {
					return $elm$core$Array$length(
						A2(
							$elm$core$Array$filter,
							$elm$core$Basics$eq($author$project$Main$Block),
							array));
				},
				board)));
};
...
var $author$project$Main$deleteLine = F2(
	function (k, board) {
		return A2(
			$elm$core$Array$append,
			A2(
			...
			A2(
				$elm$core$Array$append,
				A3($elm$core$Array$slice, 0, k, board),
				A3(
...
var $author$project$Main$deleteLines = function (board) {
	return A3(
		$elm$core$List$foldl,
		$author$project$Main$deleteLine,
		board,
		A2(
			$elm$core$List$map,
...
var $author$project$Main$putMinoToBoard = F2(
	function (board, mino) {
		return A3(
			$elm$core$List$foldr,
...
var $author$project$Main$updateModel = F2(
	function (time, model) {
		var nextMino = A2($author$project$Main$moveMino, $author$project$Main$Down, model.headMino);
		var delta = $elm$time$Time$posixToMillis(time) - $elm$time$Time$posixToMillis(model.startTime);
		return (_Utils_cmp(delta, model.updateMills) > 0) ? (A2($author$project$Main$isCollide, model, nextMino) ? _Utils_Tuple2(
			_Utils_update(
				model,
				{
					board: $author$project$Main$deleteLines(
						A2($author$project$Main$putMinoToBoard, model.board, model.headMino)),
					score: model.score + $author$project$Main$calcScore(
						A2($author$project$Main$putMinoToBoard, model.board, model.headMino)),
					startTime: time
				}),
			A2($elm$random$Random$generate, $author$project$Main$NewMino, $author$project$Main$rand)) : _Utils_Tuple2(
			_Utils_update(
				model,
				{headMino: nextMino, startTime: time}),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Update':
				var time = msg.a;
				return A2($author$project$Main$updateModel, time, model);
			case 'UpdateRight':
				return _Utils_Tuple2(
					A2($author$project$Main$moveModel, $author$project$Main$Right, model),
					$elm$core$Platform$Cmd$none);
			case 'UpdateLeft':
				return _Utils_Tuple2(
					A2($author$project$Main$moveModel, $author$project$Main$Left, model),
					$elm$core$Platform$Cmd$none);
			case 'UpdateRRotate':
				return _Utils_Tuple2(
					A2($author$project$Main$moveModel, $author$project$Main$RRotate, model),
					$elm$core$Platform$Cmd$none);
			case 'UpdateLRotate':
				return _Utils_Tuple2(
					A2($author$project$Main$moveModel, $author$project$Main$LRotate, model),
					$elm$core$Platform$Cmd$none);
			case 'NewMino':
				var type_ = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							headMino: $author$project$Main$newMino(type_)
						}),
					$elm$core$Platform$Cmd$none);
			case 'SetSystemTime':
				var time = msg.a;
...
var $author$project$Main$shapeBoard = F2(
	function (cellState, model) {
		return A2(
			$elm$core$List$map,
			function (pos) {
				return A3(
					$joakin$elm_canvas$Canvas$rect,
					_Utils_Tuple2(pos.x * 30, pos.y * 30),
					28,
					28);
			},
			A2(
				...
				A2(
					$elm$core$List$filter,
					function (item) {
						return _Utils_eq(item.b, cellState);
					},
										...
										function (y, array) {
											return A2(
												...
												F2(
													function (x, state) {
														return _Utils_Tuple2(
															A2($author$project$Main$Pos, x, y),
															state);
													}),
												array);
										}),
...
var $author$project$Main$shapeMino = function (model) {
	return A2(
		$elm$core$List$map,
		function (pos) {
			return A3(
		...
		$author$project$Main$getEachPos(model.headMino));
};
	...
	return A3(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Main$shapeBoard, $author$project$Main$Block, model)),
				A2(
				$joakin$elm_canvas$Canvas$shapes,
				_List_fromArray(
					[
				...
				A2($author$project$Main$shapeBoard, $author$project$Main$Wall, model)),
				A2(
				$joakin$elm_canvas$Canvas$shapes,
				_List_fromArray(
					[
				...
				$author$project$Main$shapeMino(model)),
				A3(
